"""
Router de gerenciamento de experimentos e runs do MLflow.

Endpoints genéricos para criar experimentos, iniciar runs, registrar
parâmetros/métricas/tags e atualizar status — usados tanto pelo pipeline
de treino da Selic (train.py) quanto para testes manuais via API.
"""
...
async def log_metric(run_id: str, request: MetricLog):
    """
    Registra uma métrica na chamada de teste (ex: mae, rmse, r2).
    """
    try:
        client.log_metric(
            run_id=run_id,
