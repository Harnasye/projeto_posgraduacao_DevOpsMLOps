...
# 2. Criar Bucket
echo "🪣 Criando bucket selic-data..."
podman compose exec storage /garage bucket create selic-data || echo "Bucket já existe."
...
podman compose exec storage /garage bucket allow selic-data --read --write --owner --key minioadmin
